    ...
    <section id="sobre" className="section-padding bg-white">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <h3 className="text-2xl md:text-3xl font-bold mb-4">Dra. Ana Souza</h3>
            <p className="text-medical-dark-blue font-medium mb-6">Clínica Geral e Medicina da Família</p>
            
            <p className="text-gray-600 mb-6">
              Formada pela Universidade Federal com especialização em Medicina da Família, a Dra. Ana Souza tem mais de 15 anos de experiência no atendimento médico personalizado.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div className="bg-medical-light-blue p-5 rounded-lg text-center">
