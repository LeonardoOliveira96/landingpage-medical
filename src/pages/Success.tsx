        ...
        <div className="min-h-screen flex flex-col">
            ...
            <main className="flex-grow flex items-center justify-center">
                <div className="container mx-auto py-16 md:py-24 animate-fade-in">
                    <div className="max-w-3xl mx-auto text-center bg-white p-10 rounded-lg shadow-lg">
                        <div className="flex justify-center mb-6">
                            <CheckCircle className="w-20 h-20 text-medical-dark-blue" />
                        </div>
                        ...
                        <p className="text-lg text-gray-600 mb-8">
                            Obrigado por entrar em contato com o Dr. Mattheus Motta. Sua mensagem foi recebida e responderemos o mais breve possível.
                        </p>
                        <div className="flex flex-wrap justify-center gap-4">
                            <Button
                                asChild
                                className="bg-medical-dark-blue hover:bg-blue-700 text-white px-6 py-6 text-lg"
                            >
